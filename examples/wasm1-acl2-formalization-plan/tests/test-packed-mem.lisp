   ...
   (current-operand-stack
    (run 5
         (make-state
          ...
          :globals nil))))
  (make-i32-val 255)))
(cw "PASS: store8(16, 0x1FF) + load8_u(16) = 255~%")
   ...
   (current-operand-stack
    (run 5
         (make-state
          ...
          :globals nil))))
  (make-i32-val 48879)))
(cw "PASS: store16(20, 0xDEADBEEF) + load16_u(20) = 48879 (0xBEEF)~%")

(cw "~%=== ALL PACKED MEMORY TESTS PASSED (10/10) ===~%")
